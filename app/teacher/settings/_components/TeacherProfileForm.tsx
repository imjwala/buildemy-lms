...
import { DeleteTeacherAccountDialog } from "./DeleteTeacherAccountDialog";
...
export const TeacherProfileForm = ({
  ...
  const form = useForm<UserProfileSchemaType>({
    ...
    defaultValues: {
      name: teacher.name,
      filekey:
        teacher.image && !teacher.image.startsWith("http") ? teacher.image : "",
      imageUrl:
        teacher.image && teacher.image.startsWith("http") ? teacher.image : "",
    },
  });
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent align="end">
                  <DropdownMenuItem asChild>
                    <DeleteTeacherAccountDialog deleteAccount={deleteAccount} />
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
            </div>
